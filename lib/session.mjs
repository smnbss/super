...
import { findRoot, baseDir, sessionsDir, activePtr, logFile } from './config.mjs';
...
function updateSessionHeader(file, userContent) {
  ...
  const description = generateDescription(userContent);
...
`;
  ...
  writeFileSync(activePtr(from), filepath);
